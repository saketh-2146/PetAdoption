...
abstract class AppLocalizations {
  ...
  /// No description provided for @categoryRabbits.
  ///
  /// In en, this message translates to:
  /// **'Rabbits'**
  String get categoryRabbits;
  ...
  /// No description provided for @adoptMeButton.
  ///
  /// In en, this message translates to:
  /// **'Adopt Me'**
  String get adoptMeButton;

  /// No description provided for @aboutPet.
  ///
  /// In en, this message translates to:
  /// **'About'**
  String get aboutPet;
  ...
  /// No description provided for @myAdoptionsMenu.
  ///
  /// In en, this message translates to:
  /// **'My Adoptions'**
  String get myAdoptionsMenu;
  ...
  /// No description provided for @adoptionRequests.
  ///
  /// In en, this message translates to:
  /// **'Adoption Requests'**
  String get adoptionRequests;

  /// No description provided for @newPetAlerts.
  ///
  /// In en, this message translates to:
  /// **'New Pet Alerts'**
  String get newPetAlerts;
  ...
  /// No description provided for @sellAPet.
  ///
  /// In en, this message translates to:
  /// **'Add Pet'**
  String get sellAPet;
  ...
  ///
  /// In en, this message translates to:
  /// **'Please select a login role first.'**
  String get selectRoleFirst;

  /// No description provided for @adminEmailOnly.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @orOption.
  ///
  /// In en, this message translates to:
